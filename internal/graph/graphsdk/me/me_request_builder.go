...
// returns a *OwnedObjectsRequestBuilder when successful
func (m *MeRequestBuilder) OwnedObjects() *OwnedObjectsRequestBuilder {
	return NewOwnedObjectsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
