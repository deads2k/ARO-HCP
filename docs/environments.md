...
| Integrated / Shared Dev (decommissioned)                                    | Red Hat / Public             | Red Hat / Public / ARO Hosted Control Planes (EA Subscription 1) | No                   | No      | Yes              | No              | No     | No                       | No   | Prow              | Azure Log Analytics | [config.yaml](../config/config.yaml) / dev                                                                                                                             |
| CS PR                                                                       | Red Hat / Public             | Red Hat / Public / ARO Hosted Control Planes (EA Subscription 1) | No                   | No      | Yes              | No              | No     | No                       | No   | Prow              | Azure Log Analytics | [config.yaml](../config/config.yaml) / cspr                                                                                                                            |
...
> [!NOTE]
> The Integrated / Shared Dev environment has been decommissioned. Only shared global resources (ACRs, DNS zones) are still deployed there via the `global-pipeline-postsubmit` Prow job, as these resources are shared by the CSPR and personal dev environments.
