...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.AccessLevel":        schema_pkg_apis_sessiongate_v1alpha1_AccessLevel(ref),
		"github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.HostedControlPlane": schema_pkg_apis_sessiongate_v1alpha1_HostedControlPlane(ref),
		"github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.ManagementCluster":  schema_pkg_apis_sessiongate_v1alpha1_ManagementCluster(ref),
		"github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.Principal":          schema_pkg_apis_sessiongate_v1alpha1_Principal(ref),
		"github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.Session":            schema_pkg_apis_sessiongate_v1alpha1_Session(ref),
		"github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.SessionList":        schema_pkg_apis_sessiongate_v1alpha1_SessionList(ref),
		"github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.SessionSpec":        schema_pkg_apis_sessiongate_v1alpha1_SessionSpec(ref),
		"github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.SessionStatus":      schema_pkg_apis_sessiongate_v1alpha1_SessionStatus(ref),
...
func schema_pkg_apis_sessiongate_v1alpha1_AccessLevel(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AccessLevel defines the RBAC permissions that the session owner is granted when accessing the target Hosted Control Plane. The permissions are defined by referencing a Kubernetes Group, which maps to a set of ClusterRoles or Roles via RoleBindings on the target HCP.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"group": {
						SchemaProps: spec.SchemaProps{
							Description: "group is the name of the Kubernetes Group (rbac.authorization.k8s.io) whose permissions the session owner will inherit when accessing the HCP. The group must exist on the target HCP and have appropriate RoleBindings or ClusterRoleBindings configured.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
...
func schema_pkg_apis_sessiongate_v1alpha1_HostedControlPlane(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "HostedControlPlane identifies a Hypershift Hosted Control Plane running on a management cluster. The HCP represents a customer's OpenShift control plane whose Kubernetes API server the session will provide access to.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"resourceId": {
						SchemaProps: spec.SchemaProps{
							Description: "resourceId is the qualified Azure Resource Manager (ARM) resource ID of the hosted cluster resource. This ID uniquely identifies the ARO-HCP cluster within the Azure subscription.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"namespace": {
						SchemaProps: spec.SchemaProps{
							Description: "namespace is the Kubernetes namespace on the management cluster where the HostedControlPlane custom resource is located. This namespace contains the HCP's control plane components and is used by the controller to locate the target HCP resources.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
				...
				Required: []string{"resourceId", "namespace"},
			},
		},
	}
}

func schema_pkg_apis_sessiongate_v1alpha1_ManagementCluster(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ManagementCluster identifies an Azure Kubernetes Service (AKS) management cluster that hosts one or more Hypershift Hosted Control Planes. The management cluster runs the HCP control plane components and is the target for session resource provisioning.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"resourceId": {
						SchemaProps: spec.SchemaProps{
							Description: "resourceId is the fully Azure Resource Manager (ARM) resource ID of the management cluster. This ID uniquely identifies the AKS cluster within the Azure subscription.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
...
func schema_pkg_apis_sessiongate_v1alpha1_Principal(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Principal identifies the authenticated Azure identity that owns this session. based on the identity type and name.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"type": {
						SchemaProps: spec.SchemaProps{
							Description: "type specifies the type of Azure identity that owns this session. Valid values are: - \"azureUser\": An Azure AD user identity (e.g., an SRE accessing the system) - \"azureServicePrincipal\": An Azure service principal identity (e.g., automation accounts)",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "name is the identifier of the Azure identity that owns this session, e.g. for azureUser: the user's email address or UPN (e.g., \"alice@example.com\") for azureServicePrincipal: the service principal's client ID / application ID",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
...
func schema_pkg_apis_sessiongate_v1alpha1_Session(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Session represents a time-limited, authenticated SRE access session to a Hypershift Hosted Control Plane (HCP). Sessions are created to grant temporary access to an HCP's Kubernetes API server for debugging, administrative operations, or support purposes. Each session is bound to a specific owner (identified by JWT claims), targets a specific HCP on a management cluster, and expires after the configured TTL. The controller provisions the necessary resources (credentials, and proxy endpoint) to enable secure access.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Description: "spec defines the desired state of the Session, including the target HCP, access permissions, TTL, and owner identity.\n\nThis field is immutable after creation to prevent privilege escalation or session hijacking. Once a session is created, its target HCP, access level, and owner cannot be modified. To change any session parameters, delete the session and create a new one.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.SessionSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "status contains the observed state of the Session, including provisioned resources, the session endpoint URL, expiration time, and condition status.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.SessionStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.SessionSpec", "github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.SessionStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_sessiongate_v1alpha1_SessionList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SessionList is a list of Session resources",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.Session"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.Session", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_sessiongate_v1alpha1_SessionSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SessionSpec defines the desired state of a Session. All fields are immutable after creation to ensure that all interactions remain auditable and to prevent privilege escalation. The spec identifies the target HCP, the management cluster hosting it, the access level granted, and the owner's identity.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"ttl": {
						SchemaProps: spec.SchemaProps{
							Description: "ttl is the time-to-live duration for the session. The session will automatically expire after this duration from its creation time. The expiration timestamp is recorded in status.expiresAt. Once expired, the session's provisioned resources are cleaned up by the controller.",
							Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Duration"),
						},
					},
					"managementCluster": {
						SchemaProps: spec.SchemaProps{
							Description: "managementCluster identifies the AKS management cluster where the target HCP is running. The controller uses this to locate and communicate with the correct management cluster when provisioning session resources.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.ManagementCluster"),
						},
					},
					"hostedControlPlane": {
						SchemaProps: spec.SchemaProps{
							Description: "hostedControlPlane identifies the Hypershift Hosted Control Plane that this session provides access to.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.HostedControlPlane"),
						},
					},
					"accessLevel": {
						SchemaProps: spec.SchemaProps{
							Description: "accessLevel defines the RBAC permissions granted to the session owner when accessing the target HCP. This determines what operations the session owner can perform on the HCP's Kubernetes API server.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.AccessLevel"),
						},
					},
					"owner": {
						SchemaProps: spec.SchemaProps{
							Description: "owner identifies the authenticated principal (user or service principal) that is authorized to use this session. The owner's identity is cryptographically verified by matching JWT claims against tokens presented during authentication.\n\nSecurity: The claims specified here form the sole basis for authentication. Only the entity whose JWT token contains ALL matching claims can access the HCP through this session. The identityName field is informational only and is NOT used for authentication decisions.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.Principal"),
						},
					},
				},
				Required: []string{"ttl", "managementCluster", "hostedControlPlane", "accessLevel", "owner"},
			},
		},
		Dependencies: []string{
			"github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.AccessLevel", "github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.HostedControlPlane", "github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.ManagementCluster", "github.com/Azure/ARO-HCP/sessiongate/pkg/apis/sessiongate/v1alpha1.Principal", "k8s.io/apimachinery/pkg/apis/meta/v1.Duration"},
	}
}

func schema_pkg_apis_sessiongate_v1alpha1_SessionStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SessionStatus reports the observed state of the Session, including the provisioned resources, the session endpoint URL for accessing the HCP, and the session's expiration time. The status is updated by the controller as it provisions and manages session resources.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"conditions": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "conditions represent the current state of the session. Known condition types are: - \"Ready\": True when the session is fully provisioned and accessible - \"CredentialsAvailable\": True when session credentials have been created - \"NetworkPathAvailable\": True when the network path to the HCP is established The status of each condition is one of True, False, or Unknown.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"expiresAt": {
						SchemaProps: spec.SchemaProps{
							Description: "expiresAt is the timestamp when the session will expire and become invalid. This is calculated as the session's creation timestamp plus the TTL specified in spec.ttl. After this time, the controller will clean up session resources and the session endpoint will no longer accept connections. This field is immutable once set.",
							Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Time"),
						},
					},
					"endpoint": {
						SchemaProps: spec.SchemaProps{
							Description: "endpoint is the URL that the session owner uses to access the HCP's Kubernetes API server. This endpoint acts as an authenticated proxy, forwarding requests to the target HCP's KAS after validating the session owner's identity. The endpoint is provisioned by the controller and becomes available when the session is ready.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"credentialsSecretRef": {
						SchemaProps: spec.SchemaProps{
							Description: "credentialsSecretRef is a reference to the Kubernetes Secret containing the session's authentication credentials. These credentials are used by the session proxy to authenticate requests and by clients to establish secure connections.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"backendKASURL": {
						SchemaProps: spec.SchemaProps{
							Description: "backendKASURL is the internal URL used by the session proxy to communicate with the target HCP's Kubernetes API server. For public HCPs, this is the HCP's public KAS endpoint. For private HCPs that are not directly accessible, this may be a local port-forward endpoint or internal service URL. This field is set by the controller based on the HCP's network configuration.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
