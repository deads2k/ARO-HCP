...
type SharedInformerFactory interface {
	...
	Sessiongate() sessiongate.Interface
}

func (f *sharedInformerFactory) Sessiongate() sessiongate.Interface {
	return sessiongate.New(f, f.namespace, f.tweakListOptions)
}
