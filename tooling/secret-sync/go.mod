...
require (
	github.com/Azure/ARO-Tools/config v0.0.0-20260408081443-a0b4376609ef // indirect
	github.com/Azure/ARO-Tools/testutil v0.0.0-20260408081443-a0b4376609ef // indirect
