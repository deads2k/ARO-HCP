...
* have a `KUBECONFIG` for a SC and MC, e.g. for your [personal DEV environment](../docs/personal-dev.md)
...
* ensure that the environment variable `$LOCATION` is either unset or set to your dev environment's region
